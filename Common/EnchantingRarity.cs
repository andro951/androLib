...
namespace androLib.Common
{
    public abstract class EnchantingRarity : ModRarity {
        ...
        public static Color[] TierColors => AndroMod.clientConfig.UseAlternateRarityColors ? altTierColors : normalTierColors;
